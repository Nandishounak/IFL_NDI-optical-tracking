...
def find_corresponding_point_transform(p1_path, p2_path):
    ...
    # R, t = rigid_transform_3D(pc_2, pc_1)
...
def main(imfusion_matrix, stl_matrix):
    ...
    R, t = find_corresponding_point_transform(imfusion_matrix, stl_matrix)
...
if __name__ == '__main__':
    ...
    main(imfusion_matrix, stl_matrix)
